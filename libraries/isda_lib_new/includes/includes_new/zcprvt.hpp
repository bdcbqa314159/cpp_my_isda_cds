...
EXPORT_C {
  ...
  ***************************************************************************
  */
  TCurve *JpmcdsZCToTCurve(ZCurve * zc); /* (I) ZCurve to copy */
  ...
  ***************************************************************************
  */
  ZCurve *JpmcdsZCFromTCurve(TCurve * tc); /* (I) TCurve to copy */
  ...
  ***************************************************************************
  */
  ZCurve *JpmcdsZCMake(TDate valueDate,    /* (I) base date for rates */
  ...
  ***************************************************************************
  */
  void JpmcdsZCFree(ZCurve * zc); /* zero curve to free */
  ...
  ***************************************************************************
  */
  int JpmcdsZCAddPrefixCurve(ZCurve * zc1,  /* (M) zCurve to added to */
  ...
  ***************************************************************************
  */
  int JpmcdsZCAddSuffixCurve(ZCurve * zc1,  /* (M) zCurve to added to */
                             ZCurve * zc2); /* (I) zCurve to add from */
  ...
  ***************************************************************************
  */
  int JpmcdsZCAddMoneyMarket(ZCurve * zc,    /* (M) ZCurve to add to */
  ...
  ** there is more than one such cash flow, several points are added to the
  *curve,
  ...
  ***************************************************************************
  */
  int JpmcdsZCAddGenRate(ZCurve * zc,        /* (M) ZCurve to add rate to */
  ...
  ***************************************************************************
  */
  int JpmcdsZCAddRate(ZCurve * zc,  /* (M) ZCurve to add rate to */
                      TDate date,   /* (I) date associated with rate */
                      double rate); /* (I) rate, in ZCurve terms */
  ...
  ***************************************************************************
  */
  int JpmcdsZCAddRateAndDiscount(ZCurve * zc, /* (M) ZCurve to add rate to */
                                 TDate date, /* (I) date associated with rate */
                                 double rate,  /* (I) rate, in ZCurve terms */
                                 double disc); /* (I) discount factor to add */
  ...
  ***************************************************************************
  */
  int JpmcdsZCComputeDiscount(ZCurve * zc, /* (I) zero curve */
  ...
  ***************************************************************************
  */
  int JpmcdsZCFindDateExact(ZCurve * zc, /* (I) ZCurve to search */
  ...
  ***************************************************************************
  */
  int JpmcdsZCFindDateClosest(ZCurve * zc, /* (I) ZCurve to search */
                              TDate date); /* (I) date to search for */

...
EXPORT_C {
  ...
  ***************************************************************************
  */
  EXPORTED TBoolean JpmcdsErrMsgStatus(void);
  ...
  ***************************************************************************
  */
  EXPORTED int JpmcdsErrMsgFileName(char *fileName, /* (I)  File name to use. */
  ...
  ***************************************************************************
  */
  EXPORTED char *JpmcdsErrMsgGetFileName(void);
  ...
  ***************************************************************************
  */
  EXPORTED char **JpmcdsErrGetMsgRecord(void);
  ...
  ***************************************************************************
  */
  EXPORTED int JpmcdsErrMsgEnableRecord(
  ...
  ***************************************************************************
  */
  EXPORTED int JpmcdsErrMsgDisableRecord(void);
  ...
  */
   ...
   *
   * After you add a callback, then any call to JpmcdsErrMsg which would
   * otherwise result in a message being written to file (not that if error
   * messaging is off then messages are not being written to file) will first
   * invoke a call to the callback routine.
   *
   ...
   */
  EXPORTED void JpmcdsErrMsgAddCallback(
   ...
   */
  EXPORTED void JpmcdsErrMsgGetCallback(
